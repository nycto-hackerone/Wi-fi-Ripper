...
setWindowTitle(){
	...
	title='echo -ne "\033]0;WiFi Ripper v1\007"'
...
setVariablesRequired(){
	...
	updateMaster=https://raw.githubusercontent.com/nycto-hackerone/Wi-fi-Ripper/blob/master/wifi-ripper/wifi-ripper.sh
...
banner(){
	...
	clear
	$green
        echo "                                 _  _  _  _  _______  _    ______   _                             "                            
        echo "                                | || || |(_)(_______)(_)  (_____ \ (_)                            "                           
        echo "                                | || || | _  _____    _    _____) ) _  ___    ____    ____   ____ " 
        echo "                                | ||_|| || ||  ___)  | |  (_____ ( | ||  _ \ |  _ \  / _  ) / ___)"
        echo "                                | |___| || || |      | |        | || || | | || | | |( (/ / | |    "
        echo "                                 \______||_||_|      |_|        |_||_|| ||_/ | ||_/  \____)|_|    "
        echo "                                                                      |_|    |_|                  "
        $blue
	echo "---------------------    ***************************************************************************    ----------------------"
	echo "|  [M] Main Menu    |    * Wifi Ripper v$versionBase  /  Nycto 2018  /  github.com/nycto-hackerone          *    | [X] Exit           |"
	echo "---------------------    ***************************************************************************    ----------------------"
	$yellow
	echo "-------------------------------------------------------------------------------------------------------------------"
...
bannerNoMenu(){
	...
	$green
        ...
        $blue
	echo "---------------------    ***************************************************************************    ----------------------"
	echo "|  [ CTRL+C ] Main  |    * Wifi Ripper v$versionBase  /  Nycto 2018  /  github.com/nycto-hackerone          *    | [CTRL+C x2 ] Exit  |"
	echo "---------------------    ***************************************************************************    ----------------------"
	$yellow
	echo "-------------------------------------------------------------------------------------------------------------------"
	echo "| Interfaces: $interfacesFound  |  Interface Mode: $interfaceMode  |  [A] Advanced  |  Sessions: [S] Save  [L] Load  |  [E] Extras  [H] Help  |"
...
bannerMain(){
	...
	$green
        ...
        $blue
	echo "---------------------    ***************************************************************************    ----------------------"
	echo "|  [ ]              |    * Wifi Ripper v$versionBase  /  Nycto 2018  /  github.com/nycto-hackerone          *    | [CTRL+C    ] Exit  |"
	echo "---------------------    ***************************************************************************    ----------------------"
	echo "-------------------------------------------------------------------------------------------------------------------"
	$yellow
	echo "| Interfaces: $interfacesFound  |  Interface Mode: $interfaceMode  |  [A] Advanced  |  Sessions: [S] Save  [L] Load  |  [E] Extras  [H] Help  |"
...
bannerExit(){
	...
	echo ""
	echo "https://github.com/nycto-hackerone"
	echo ""
	echo ""
...
bannerExitUpdate(){
	...
	clear
	$green
	echo "The WiFi Ripper Script Has Been Updated To Version $versionRemote"
	echo ""
...
checkWifiandDisplayMessage(){
	...
	case "$ipStatusText" in
		...
		banner
		echo ""
		echo "DISCONNECT FROM WIFI BEFORE CONTINUING!!!!"
		echo ""
		echo ""
...
menuMain(){
	...
	case "$ipStatus" in
		...
		$red
		echo "*************************************************************"
		echo "DISCONNECT FROM ANY WIRELESS CONNECTIONS BEFORE CONTINUING!!!"
		echo "*************************************************************"
		echo ""
...
menuAuto(){
	...
	$green
	echo ""
	echo "You can begin the $encryptionTypeText attack!"
	echo ""
	$white
...
setWindowTitle(){
	...
	title='echo -ne "\033]0;WiFi Ripper v1.9\007"'
...
setVariablesRequired(){
	...
	versionRemoteTemp="0.0"
	newUpdateAvailable="0"
	updateMaster=https://raw.githubusercontent.com/nycto-hackerone/wifi-ripper/master/wifi-ripper.sh
	updateTemp="/tmp/update-check.tmp"
	updateChecked="0"
	skipUpdate="0"
	returnToUpdatePage="0"
